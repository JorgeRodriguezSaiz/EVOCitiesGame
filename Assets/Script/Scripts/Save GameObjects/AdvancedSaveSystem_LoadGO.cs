...
public class AdvancedSaveSystem_LoadGO : MonoBehaviour {
    ...
    void Start()
    {
        ...
        specialPath = transform.GetComponent<AdvancedSaveSystem_SaveGO>().specialPath;
    ...
    {
        /*if (File.Exists(Application.persistentDataPath + "/Datos.json"))
        {
            BinaryFormatter binary = new BinaryFormatter();
            FileStream fStream = File.Open(Application.persistentDataPath + "/Datos.json", FileMode.Open);
            DatosGuardado saver = (DatosGuardado)binary.Deserialize(fStream);
            fStream.Close();
            print("A");
        }*/
          ...
          AdvancedSaveSystem_MessageSystem.msg = "Gameobjects Loaded!";
    }
